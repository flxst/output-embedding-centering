# taken from https://github.com/KellerJordan/modded-nanogpt/blob/master/data/cached_fineweb100B.py
# and slightly modified

TARGET_DIRECTORY = '.'  # TODO: CHANGEME
...
def get(fname):
    local_dir = os.path.join(TARGET_DIRECTORY, 'fineweb')
